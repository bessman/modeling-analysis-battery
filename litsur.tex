...
The process is reversed during discharge \cite{reddy_thomas_lindens_2011}.
Typical positive electrode materials are LiCoO\textsubscript{2}, LiMn\textsubscript{2}O\textsubscript{4}, and LiFePO\textsubscript{4}.
...
Lithium-ion battery technology is a further development of the older lithium metal battery.
...
While this battery type has very high energy density, the presence of metallic lithium in the cells is a serious safety hazard \cite{lisbona_review_2011}.
In 1987, Akira Yoshino patented a cell design which used Li\textsuperscript{+}-ions as the primary charge carryer between to non-metallic electrodes \cite{yoshino_secondary_1987}.
Instead of lithium, the negative electrode used carbon as the active material.
Since the lithium-ion battery was first commercialized by Sony in 1991, the technology has grown to dominate the mobile appliances market \cite{yoshio_lithium-ion_2009}.
It has also recieved considerable research effort, greatly improving energy density, power density, longevity, and cost efficiency.
...
However, many challenges remain before lithium-ion batteries are suitable for large-scale deployment in vehicles.
